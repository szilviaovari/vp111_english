...
function checkBrowserZoom() {
  var zoomLevel = Math.round((window.devicePixelRatio * 100) / 1);
  if (zoomLevel !== 100) {
      alert("A kijelződ nagyítási szintje nem 100%. Kérlek állítsd át 100%-ra.");
      window.location.href = "../";
  }
}
